...
export function ArtworkDetails() {
  ...
  return (
    <article className="sticky top-28 flex flex-col gap-4 rounded-lg bg-white p-4 shadow-lg ring-1 ring-gray-200 dark:bg-gray-900 dark:shadow-black/40 dark:ring-gray-700">
      <button
        onClick={handleClose}
